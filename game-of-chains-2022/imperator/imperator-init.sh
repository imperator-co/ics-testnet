#!/bin/bash
# Set up a imperator service to join the imperator-1 chain.
...
NODE_HOME=~/.imperator
NODE_MONIKER=imperator
# ***

CHAIN_BINARY_URL='https://github.com/imperator-co/imperator-core/releases/download/v0.1.0/imperatord'
CHAIN_BINARY='imperatord'
CHAIN_ID=imperator-1
...
# rm -rf imperator
# git clone https://github.com/imperatorrv/imperator.git
# cd imperator
...
echo "Description=imperator service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the imperator service:"
